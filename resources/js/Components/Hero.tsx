...
interface HeroProps {
  ...
  return (
    <div className='flex justify-center -mt-[4em]  bg-center bg-[url("/images/hero.jpg")] bg-cover w-full items-center h-[600px] flex-col text-white font-["OpenSans"] text-center'>
