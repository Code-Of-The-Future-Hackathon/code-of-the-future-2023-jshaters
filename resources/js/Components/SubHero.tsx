...
const SubHero : React.FC<SubHeroProps> = ({ theme }) => {
  ...
  return (
    <Box sx={{py : 30, px: matches? 20 : 0, width: '100vw'}}>
        <Typography variant="h3" component="h3"  align={matches ? "left" : "center"} sx={{ fontFamily: 'OpenSans' }}>Make your decision</Typography>
